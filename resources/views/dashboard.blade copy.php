            ...
            <div class="mb-6 pb-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <a href="{{ route('kelola-workspace') }}"
                        class="inline-flex items-center justify-center gap-2 text-sm sm:text-base bg-white text-[#225AD6] border border-blue-200 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold shadow-md hover:bg-blue-50">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const shouldShowOnboarding = {
            {
                isset($showOnboarding) && $showOnboarding ? 'true' : 'false'
            }
        };
