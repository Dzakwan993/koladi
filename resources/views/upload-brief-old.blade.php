...
@section('content')
    ...
    <div class="min-h-screen bg-[#e9effd] py-8 px-4" x-data="uploadBriefComponent()">
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="max-w-2xl mx-auto text-center">
                ...
                <p class="text-sm text-slate-500 mt-2">
                    Unggah dokumen brief proyek Anda atau pilih template siap pakai agar AI dapat menyusun strategi,
                    deliverables, dan daftar tugas secara otomatis.
                </p>
            </div>

            {{-- Form wrapper --}}
            <form action="{{ route('brief.upload') }}" method="POST" enctype="multipart/form-data" id="uploadForm"
                class="space-y-6" @submit="handleFormSubmit($event)">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
                    ...
                    <div class="lg:col-span-5 flex flex-col justify-between relative">
                        ...
                        <div class="flex items-center justify-between mb-2.5 select-none">
                            ...
                            <span
                                class="inline-flex items-center gap-1 text-[11px] font-semibold text-blue-700 bg-blue-50 px-2.5 py-0.5 rounded-full border border-blue-100">
                                <svg class="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                        ...
                        <div @click="openTemplateModal()"
                            ...
                            <div class="relative z-10 space-y-4">
                                <div class="flex items-center justify-between">
                                    <div
                                        class="w-12 h-12 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-[#225AD6] group-hover:bg-[#225AD6] group-hover:text-white transition-colors duration-200 shadow-sm">
                                    ...
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-100 text-slate-600 text-[11px] font-medium border border-slate-200">
                                        Opsional
                                    </span>
                                </div>
                                ...
                                <div>
                                    <h2
                                        class="text-lg font-bold text-slate-800 leading-snug group-hover:text-[#225AD6] transition-colors">
                                        Panduan &amp; Template Projek</h2>
                                    <p class="text-xs text-slate-500 mt-1.5 leading-relaxed">
                                        Belum punya dokumen tertulis? Gunakan panduan struktur ini sebagai acuan poin-poin
                                        penting yang perlu dicatat saat meeting bersama tim atau klien.
                                    </p>
                                </div>
                                ...
                                <div class="space-y-2.5 pt-3 border-t border-slate-100">
                                    <div class="flex items-center gap-2.5 text-xs text-slate-600">
                                        <div
                                            class="w-4 h-4 rounded-full bg-blue-50 text-[#225AD6] flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="relative z-10 mt-6 pt-4 border-t border-slate-100">
                                <button type="button"
                                    ...
                                    <svg class="w-4 h-4 text-slate-400 group-hover:text-white group-hover:translate-x-1 transition-all"
                    ...
                    <div class="lg:col-span-7 flex flex-col">
                        <div class="flex items-center justify-between mb-2.5 select-none">
                            <span class="text-xs font-bold text-slate-500 uppercase tracking-wider">Unggah File
                                Fisik</span>
                            <span class="text-[11px] text-slate-400">PDF, DOCX, TXT</span>
                        </div>

                        {{-- Dropzone Card --}}
                        <div class="relative flex-1 bg-white border-2 border-dashed border-slate-200 rounded-3xl p-6 sm:p-8 overflow-hidden cursor-pointer transition-all hover:border-blue-400 hover:bg-blue-50/20 flex flex-col justify-between text-center group"
                            id="dropzone">
                            <div class="relative flex flex-col items-center">
                                ...
                                <input type="file" name="documents[]" id="fileInput"
                                    ...
                                    accept=".pdf,.docx,.txt" onchange="updateFileList()"
                                    onclick="handleFileInputClick(event)">

                                {{-- Icon --}}
                                <div class="relative mb-3">
                                    <div
                                        class="w-14 h-14 rounded-2xl bg-blue-50 text-[#225AD6] flex items-center justify-center group-hover:bg-[#225AD6] group-hover:text-white transition-colors duration-200 shadow-sm">
                                        <svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="1.5"
                                            viewBox="0 0 24 24">
                                            <path d="M8 3h5l5 5v11a2 2 0 01-2 2H8a2 2 0 01-2-2V5a2 2 0 012-2z"
                                ...
                                <p class="text-xs text-slate-500 mt-1">Tarik &amp; lepas file atau klik untuk memilih
                                    dokumen</p>

                                {{-- File type chips --}}
                                <div class="flex items-center gap-2 mt-3 relative z-20">
                                    <span
                                        class="inline-flex items-center gap-1.5 text-xs font-medium text-slate-600 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1">
                                        PDF
                                    </span>
                                    <span
                                        class="inline-flex items-center gap-1.5 text-xs font-medium text-slate-600 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1">
                                ...
                                <div class="grid grid-cols-5 gap-2 w-full max-w-sm mx-auto mt-3 relative z-20">
                                    <div class="text-center">
                                        <div
                                            class="w-10 h-10 mx-auto rounded-full bg-purple-50 flex items-center justify-center">
                                            <img src="{{ asset('images/icons/Meet.svg') }}" alt="Meeting Icon"
                                                class="w-6 h-6">
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <div
                                            class="w-10 h-10 mx-auto rounded-full bg-purple-50 flex items-center justify-center">
                                            <img src="{{ asset('images/icons/Drive.svg') }}" alt="Drive Icon"
                                                class="w-6 h-6">
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <div
                                            class="w-10 h-10 mx-auto rounded-full bg-purple-50 flex items-center justify-center">
                                            <img src="{{ asset('images/icons/Notion.svg') }}" alt="Notion Icon"
                                                class="w-6 h-6">
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <div
                                            class="w-10 h-10 mx-auto rounded-full bg-purple-50 flex items-center justify-center">
                                            <img src="{{ asset('images/icons/Gmail.svg') }}" alt="Gmail Icon"
                                                class="w-6 h-6">
                                        </div>
                            ...
                            <div class="relative w-full mt-5">
                                <div class="bg-gradient-to-r from-purple-50 via-pink-50 to-blue-50 rounded-xl px-4 py-2.5">
                                    <p
                                        class="text-[11px] text-slate-600 flex items-center justify-center gap-1.5 flex-wrap text-center">
                ...
                <div x-show="isTemplateMode" x-cloak
                    class="w-full bg-white border-2 border-indigo-200 rounded-3xl p-6 shadow-md relative overflow-hidden">
                    <div
                        class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 pb-3 border-b border-slate-100">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-11 h-11 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center flex-shrink-0 shadow-sm border border-indigo-100">
                            ...
                            <div>
                                <div class="flex items-center gap-2">
                                    <span
                                        class="inline-flex items-center gap-1 text-[10px] font-extrabold uppercase tracking-wider text-emerald-700 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-full">
                                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                        Template Konteks Terpilih
                                    </span>
                                </div>
                                <h3 class="text-base font-bold text-slate-800 mt-0.5"
                                    x-text="'Template Konteks - ' + selectedTemplate.name"></h3>
                            </div>
                        </div>

                        <div class="flex items-center gap-2 self-end sm:self-center">
                            <button type="button" @click="editCurrentTemplate()"
                            ...
                            <button type="button" @click="clearSelectedTemplate()"
                    ...
                    <div
                        class="grid grid-cols-1 sm:grid-cols-2 gap-3.5 bg-slate-50 border border-slate-100 rounded-2xl p-4 text-xs">
                        <div>
                            <p class="font-bold text-slate-400 uppercase text-[10px] tracking-wider mb-0.5">Tujuan Projek
                            </p>
                            <p class="text-slate-700 line-clamp-2" x-text="selectedTemplate.goal || '—'"></p>
                        </div>
                        <div>
                            <p class="font-bold text-slate-400 uppercase text-[10px] tracking-wider mb-0.5">Periode Projek
                            </p>
                        ...
                        <div class="sm:col-span-2 border-t border-slate-200/60 pt-2.5 mt-0.5"
                            x-show="selectedTemplate.phases">
                            <p class="font-bold text-slate-400 uppercase text-[10px] tracking-wider mb-0.5">Tahapan / Fase
                                Projek</p>
                            <p class="text-slate-700 whitespace-pre-line line-clamp-2"
                                x-text="selectedTemplate.phases || '—'"></p>
                        </div>
                        <div class="sm:col-span-2 border-t border-slate-200/60 pt-2.5 mt-0.5">
                            <p class="font-bold text-slate-400 uppercase text-[10px] tracking-wider mb-0.5">Output Akhir
                                Projek (Deliverables)</p>
                ...
                <div id="fileListContainer"
                    class="hidden w-full bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
                    <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider block mb-3">Berkas yang
                        dipilih:</span>
        ...
        <div x-show="showTemplateModal" x-cloak
            class="fixed inset-0 z-[9990] flex items-center justify-center p-4 overflow-y-auto" style="display: none;">
            {{-- Backdrop --}}
            <div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm transition-opacity" @click="closeTemplateModal()">
            </div>

            {{-- Modal Content Card --}}
            <div class="relative bg-white rounded-3xl shadow-2xl border border-slate-100 w-full max-w-2xl my-8 overflow-hidden z-10 transform transition-all"
                ...
                <template x-if="templateStep === 1">
                    <div>
                        ...
                        <div class="px-6 pt-6 pb-4 border-b border-slate-100 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-2xl bg-indigo-50 flex items-center justify-center flex-shrink-0 text-indigo-600">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 mt-0.5">Pilih salah satu template untuk melihat
                                        struktur dan rincian isinya.</p>
                                </div>
                            </div>
                        ...
                        <div class="p-6 max-h-[70vh] overflow-y-auto space-y-3">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                                <template x-for="(tmpl, idx) in availableTemplates" :key="idx">
                                    <div @click="selectTemplatePreset(tmpl)"
                                        ...
                                        <div>
                                            <div class="flex items-center justify-between mb-2.5">
                                                <span
                                                    ...
                                                    :class="tmpl.badgeClass" x-text="tmpl.category"></span>
                                                <svg class="w-4 h-4 text-slate-400 group-hover:text-indigo-600 group-hover:translate-x-0.5 transition-all"
                                            ...
                                            <h4 class="text-sm font-bold text-slate-800 group-hover:text-indigo-600 transition-colors"
                                                x-text="tmpl.name"></h4>
                                            <p class="text-xs text-slate-500 mt-1 leading-relaxed"
                                                x-text="tmpl.description"></p>
                                        </div>

                                        <div
                                            class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-400">
                                            ...
                                            <span class="font-semibold text-indigo-600 group-hover:underline">Pilih
                                                &rarr;</span>
                                        </div>
                                    </div>
                                </template>
                ...
                <template x-if="templateStep === 2">
                    <div>
                        ...
                        <div class="px-6 pt-6 pb-4 border-b border-slate-100 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <button type="button" @click="templateStep = 1"
                                ...
                                <div>
                                    <h3 class="text-base font-bold text-slate-800 leading-tight"
                                        x-text="'Kustomisasi: ' + formTemplate.name"></h3>
                                    <p class="text-xs text-slate-500 mt-0.5">Tinjau dan sesuaikan isi field template di
                                        bawah ini.</p>
                                </div>
                            </div>
                        ...
                        <div class="p-6 max-h-[65vh] overflow-y-auto space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" x-model="formTemplate.name"
                            ...
                            <div>
                                ...
                                <textarea x-model="formTemplate.goal" rows="3"
                            ...
                            <div class="bg-slate-50 border border-slate-200/80 rounded-2xl p-4 space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="text-[10px] font-semibold text-indigo-600 bg-indigo-50 border border-indigo-100/60 px-2 py-0.5 rounded-md flex items-center gap-1">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="date" x-model="formTemplate.start_date" @change="onDateChange()"
                                    ...
                                    <div>
                                        ...
                                        <input type="date" x-model="formTemplate.end_date" @change="onDateChange()"
                                            class="w-full text-sm border border-slate-200 rounded-xl px-3 py-2 bg-white text-slate-700 focus:ring-2 focus:ring-indigo-500 focus:outline-none shadow-sm">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" x-model="formTemplate.period"
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1.5">
                                    ...
                                    <span
                                        class="text-[10px] text-indigo-600 font-semibold bg-indigo-50 px-2 py-0.5 rounded-md">Penting
                                        untuk Timeline</span>
                                </div>
                                <textarea x-model="formTemplate.phases" rows="3"
                                    ...
                                    class="w-full text-sm border border-slate-200 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none resize-y text-slate-800"></textarea>
                                <p class="text-[11px] text-slate-400 mt-1">💡 Catat tahapan kerja utama per fase agar
                                    timeline proyek mudah dipetakan.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea x-model="formTemplate.deliverables" rows="3"
                            ...
                            <div>
                                ...
                                <textarea x-model="formTemplate.scope" rows="3"
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-1.5">
                                    Tim / Role yang Terlibat <span
                                        class="text-slate-400 font-normal normal-case">(Opsional)</span>
                                </label>
                                <input type="text" x-model="formTemplate.roles"
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-1.5">
                                    Estimasi Anggaran &amp; Kebutuhan Khusus <span
                                        class="text-slate-400 font-normal normal-case">(Opsional)</span>
                                </label>
                                <textarea x-model="formTemplate.budget" rows="2"
        ...
        <div id="aiConsentModal" class="fixed inset-0 z-[9998] flex items-center justify-center p-4"
            style="display: none !important;">
            {{-- Backdrop --}}
            <div class="absolute inset-0 bg-slate-900/60 backdrop-blur-sm" id="aiConsentBackdrop"></div>

            {{-- Modal Card --}}
            <div class="relative bg-white rounded-2xl shadow-2xl border border-slate-100 w-full max-w-md mx-auto overflow-hidden"
                    ...
                    <div class="flex items-center gap-3 mb-1">
                        <div class="w-9 h-9 rounded-xl bg-indigo-50 flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" stroke-width="1.8"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.955 11.955 0 003 12c0 2.458.728 4.745 1.98 6.65l.01.015M17.25 6.003A11.95 11.95 0 0121 12c0 2.264-.6 4.39-1.651 6.22M7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0z" />
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-base font-bold text-slate-800 leading-tight">Persetujuan Pemrosesan Dokumen
                                dengan AI</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-slate-800 mb-0.5">Dokumen &amp; Konteks Anda akan diproses
                                oleh AI</p>
                            <p class="text-xs text-slate-500 leading-relaxed">Koladi akan menganalisis dokumen atau
                                template untuk menyusun draft project, seperti ringkasan, deliverables, daftar tugas,
                                deadline, dan pertanyaan klarifikasi.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-50 border border-slate-100 rounded-xl p-4">
                        ...
                        <ul class="space-y-2.5">
                            <li class="flex items-start gap-2">
                                <svg class="w-3.5 h-3.5 text-indigo-500 mt-0.5 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.7-9.3a1 1 0 00-1.4-1.4L9 10.6 7.7 9.3a1 1 0 00-1.4 1.4l2 2a1 1 0 001.4 0l4-4z"
                                        clip-rule="evenodd" />
                                </svg>
                                <span class="text-xs text-slate-600 leading-relaxed">Data hanya diproses untuk menghasilkan
                                    draft project pada workspace ini.</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-3.5 h-3.5 text-indigo-500 mt-0.5 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                                ...
                                <span class="text-xs text-slate-600 leading-relaxed">Hasil AI dapat mengandung kesalahan
                                    sehingga perlu ditinjau, diedit, atau ditolak sebelum disimpan.</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-3.5 h-3.5 text-amber-500 mt-0.5 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"
                                        clip-rule="evenodd" />
                                </svg>
                                <span class="text-xs text-slate-600 leading-relaxed">Hindari mengunggah data sensitif yang
                                    tidak diperlukan, seperti password, nomor kartu kredit, atau data keuangan
                                    pribadi.</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                        clip-rule="evenodd" />
                                </svg>
                                <span class="text-xs text-slate-600 leading-relaxed">Data Anda diproses secara aman untuk
                                    analisis dan tidak digunakan untuk melatih model AI publik.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <label id="aiConsentLabel" class="flex items-start gap-3 cursor-pointer select-none group">
                        <div class="relative mt-0.5 flex-shrink-0">
                            <input type="checkbox" id="aiConsentCheckbox"
                ...
                <div class="px-6 py-4 bg-slate-50 rounded-b-2xl flex justify-end gap-2">
                    <button type="button" id="aiConsentCancelBtn" onclick="closeAiConsentModal()"
                    ...
                    <button type="button" id="aiConsentAgreeBtn" onclick="handleAiConsentApproved()" disabled
        ...
        {{-- ✅ BARU: Overlay Menunggu Transkrip --}}
        <div id="transcriptWaitingOverlay"
            class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[9999] flex flex-col items-center justify-center hidden">
            <div class="bg-white p-8 rounded-3xl shadow-xl flex flex-col items-center max-w-sm w-full mx-4 border border-slate-100"
                id="transcriptWaitingCard">
                ...
                <p class="text-xs text-slate-500 text-center leading-relaxed">Transkrip akan otomatis masuk begitu meeting
                    berakhir. Halaman ini tidak perlu di-refresh.</p>
            </div>
        </div>
        ...
        <div id="loadingOverlay"
            class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[9999] flex flex-col items-center justify-center hidden">
            <div
                class="bg-white p-8 rounded-3xl shadow-xl flex flex-col items-center max-w-sm w-full mx-4 border border-slate-100">
                <div class="relative w-16 h-16 mb-4">
                    <div class="absolute inset-0 rounded-full border-4 border-slate-100"></div>
                    <div class="absolute inset-0 rounded-full border-4 border-t-indigo-600 animate-spin"></div>
                </div>
                <h3 class="text-lg font-bold text-slate-800 mb-1">Menganalisis Konteks Proyek...</h3>
                <p class="text-xs text-slate-500 text-center leading-relaxed">AI sedang memproses brief Anda dan menyusun
                    strategi proyek, timeline, serta daftar tugas terbaik.</p>
            </div>
        </div>
    </div>
    ...
    @push('scripts')
        <script>
                ...
                return {
                    ...
                    onDateChange() {
                        if (this.formTemplate.start_date && this.formTemplate.end_date) {
                            ...
                            this.formTemplate.period =
                                `Deadline: ${end.getDate()} ${months[end.getMonth()]} ${end.getFullYear()}`;
                        } else if (this.formTemplate.start_date) {
                            const start = new Date(this.formTemplate.start_date);
                            const months = ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agu', 'Sep', 'Okt', 'Nov', 'Des'];
                            this.formTemplate.period =
                                `Mulai: ${start.getDate()} ${months[start.getMonth()]} ${start.getFullYear()}`;
                        }
                    },
            ...
            // ✅ BARU: Polling Transkrip Meeting
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (waitingEvent && workspaceId) {
                    document.getElementById('transcriptWaitingOverlay').classList.remove('hidden');
                ...
                `;
                    ...
                    try {
                        ...
                        if (data.status === 'ready' && data.file_id) {
                            clearInterval(interval);
                            document.getElementById('transcriptWaitingOverlay').classList.add('hidden');
