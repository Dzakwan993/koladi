...
@section('content')
    <div x-data="documentSearch()"
        x-init="resetAllModals(); 
        $store.workspace = { selectedMenu: 'dokumen' };
        // Inisialisasi data dari backend
        initData(@js($folders), @js($rootFiles), @js($workspace)); 
        " 
        x-cloak
    ...
    @include('components.dokumen-modal')
        ...
        <div x-show="!ready" 
            ...
            <div class="border border-gray-200 rounded-lg bg-white p-6 flex items-center justify-center h-[calc(100vh-200px)]">
