...
@section('content')
    ...
    <script>
        ...
        async function checkScheduleConflicts() {
            ...
            // ✅ FIXED: Gunakan endpoint jadwal umum (company)
            const apiUrl = `/jadwal-umum/check-conflicts`;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            ClassicEditor.create(document.getElementById('catatan-editor'), {
            ...
            document.getElementById('scheduleForm').addEventListener('submit', async function(e) {
                ...
                // ✅ FIXED: Gunakan endpoint jadwal umum
                const apiUrl = `/jadwal-umum/check-conflicts`;
