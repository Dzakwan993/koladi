...
@section('content')
        ...
        <div class="min-h-screen flex justify-center pt-4 md:pt-8 pb-8 bg-[#f3f6fc] px-3 md:px-6">
            ...
            <form action="{{ route('jadwal-umum.store') }}" method="POST" id="scheduleForm"
                ...
                <div class="flex flex-col gap-2">
                    <label class="mb-1 font-medium text-sm md:text-base text-black">Peserta <span class="text-red-500">*</span></label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('scheduleForm').addEventListener('submit', function(e) {
                ...
                if (!startDate || !startTime || !endDate || !endTime) {
                    Swal.fire({ icon: 'error', title: 'Oops...', text: 'Mohon isi tanggal dan waktu dengan lengkap' });
                    return false;
                }
                ...
                if (endDateTime <= startDateTime) {
                    Swal.fire({ icon: 'error', title: 'Oops...', text: 'Waktu akhir harus lebih besar dari waktu mulai' });
                    return false;
                }
    ...
    <style>
        ...
        .ck-editor__editable { min-height: 180px; max-height: 400px; }
    </style>
@endsection
