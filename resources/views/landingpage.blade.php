...
<body class="bg-gray-50 text-gray-800">
    ...
    <nav class="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-sm z-50 transition-all duration-300">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-12">
                    <a href="#beranda" class="font-bold text-gray-700 hover:text-blue-600 transition-colors">Beranda</a>
                    <a href="#fitur" class="font-bold text-gray-700 hover:text-blue-600 transition-colors">Fitur</a>
                    <a href="#tentang" class="font-bold text-gray-700 hover:text-blue-600 transition-colors">Tentang</a>
                    <a href="#paket" class="font-bold text-gray-700 hover:text-blue-600 transition-colors">Paket</a>
                </div>
               ...
               transition-all duration-200 shadow-sm hover:shadow-md">
                    ...
                    <a href="{{ route('daftar') }}">
                        <button
                            class="px-6 py-2.5 bg-gray-100 text-gray-800 font-bold text-[13px] rounded-full
               hover:bg-gray-200 hover:-translate-y-0.5 active:scale-95
               transition-all duration-200 shadow-sm hover:shadow-md">
                            Daftar
                        </button>
                    </a>
        ...
        <div id="mobileMenu" class="hidden md:hidden bg-white border-t">
            <div class="container mx-auto px-4 py-4 space-y-4">
                <a href="#beranda" class="block font-medium hover:text-blue-600 transition-colors">Beranda</a>
                <a href="#fitur" class="block font-medium hover:text-blue-600 transition-colors">Fitur</a>
                <a href="#tentang" class="block font-medium hover:text-blue-600 transition-colors">Tentang</a>
                <a href="#paket" class="block font-medium hover:text-blue-600 transition-colors">Paket</a>
                <div class="flex flex-col space-y-2 pt-4 border-t">
                    <a href="{{ route('masuk') }}">
                        <button
                            class="w-full py-2.5 bg-blue-600 text-white font-bold text-[13px] rounded-full
               hover:bg-blue-700 transition-all duration-200 shadow-sm">
                    ...
                    <a href="{{ route('daftar') }}">
                        <button
                            class="w-full py-2.5 bg-gray-100 text-gray-800 font-bold text-[13px] rounded-full
    ...
    <!-- Hero Section -->
    <section id="beranda" class="min-h-screen flex items-center bg-white overflow-hidden relative pt-28 pb-16">
        <!-- Subtle Glow Effects -->
        <div class="absolute -top-40 -left-40 w-96 h-96 bg-blue-100/60 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute top-1/2 right-0 w-[500px] h-[500px] bg-indigo-100/40 rounded-full blur-3xl pointer-events-none"></div>

        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="grid lg:grid-cols-12 gap-12 items-center">

                <!-- Left Content -->
                <div class="lg:col-span-6 text-center lg:text-left space-y-6 flex flex-col items-center lg:items-start mt-6 lg:mt-0 order-2 lg:order-1">

                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.12] tracking-tight">
                        Satu Proyek,<br>
                        <span class="text-blue-600">Satu Konteks.</span>
                    </h1>

                    <p class="text-base sm:text-lg text-gray-600 font-normal leading-relaxed max-w-lg mx-auto lg:mx-0">
                        Kelola seluruh proyek, tugas tim, pengumuman, chat, dan analisis AI cerdas dalam satu ruang kerja yang terpadu dan efisien.
                    </p>

                    <!-- CTA Buttons -->
                    <div class="flex flex-wrap justify-center lg:justify-start items-center gap-4 pt-2">
                        <a href="{{ route('daftar') }}">
                            <button class="px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-full shadow-lg shadow-blue-600/20 hover:-translate-y-0.5 active:scale-95 transition-all duration-200 flex items-center gap-2">
                                Coba Gratis Sekarang <span>→</span>
                            </button>
                        </a>
                        <a href="#paket">
                            <button class="px-8 py-3.5 bg-white border border-gray-300 hover:border-gray-400 text-gray-800 font-bold text-sm rounded-full hover:-translate-y-0.5 transition-all duration-200 shadow-sm">
                                Lihat Paket Harga
                            </button>
                        </a>
                    </div>
                ...
                <!-- Right Content - Laptop Mockup with Modern Micro-Cards -->
                <div class="lg:col-span-6 relative animate-slideInRight flex justify-center items-center w-full mt-8 lg:mt-0 order-1 lg:order-2">
                    <div class="relative w-full max-w-2xl transform hover:scale-[1.02] transition-all duration-500">
                        ...
                        <div class="absolute -top-4 -right-2 sm:-right-4 bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-2xl p-3 shadow-xl flex items-center gap-3 z-20 animate-float" style="animation-duration: 4s;">
                            ...
                            <div class="text-left">
                                <p class="text-xs font-bold text-gray-900 leading-tight">AI Brief Parser</p>
                                <p class="text-[11px] font-semibold text-emerald-600">✓ Tugas Terbuat Otomatis</p>
                            </div>
                        </div>

                        <!-- Floating Micro-Card 2 (Bottom Left) -->
                        <div class="absolute -bottom-4 -left-2 sm:-left-4 bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-2xl p-3 shadow-xl flex items-center gap-3 z-20 animate-float" style="animation-duration: 5s; animation-delay: 1.5s;">
                            ...
                            <div class="text-left">
                                <p class="text-xs font-bold text-gray-900 leading-tight">Project Context</p>
                                <p class="text-[11px] font-medium text-slate-500">Semua tim tersinkron</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="fitur" class="py-20 bg-slate-50 text-slate-800 relative overflow-hidden">
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="text-center mb-16">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100/70 text-blue-700 text-xs font-bold uppercase tracking-wider mb-4">
                    Fitur Unggulan
                </div>
                <h2 class="text-3xl md:text-4xl font-black mb-4 text-slate-900">
                    Fitur Lengkap untuk Produktivitas Tim
                </h2>
                <p class="text-base sm:text-lg text-slate-600 font-medium">Semua yang tim Anda butuhkan, terintegrasi dalam satu workspace!</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-16">
                ...
                <div
                    ...
                    <div class="mb-5 w-12 h-12 rounded-xl bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">AI Planner</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">Otomatis ekstrak brief dan buat task detail dari dokumen PDF, Word, atau chat.</p>
                </div>

                <!-- 2. Workspaces -->
                <div
                    class="group p-8 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="mb-5 w-12 h-12 rounded-xl bg-indigo-50 text-indigo-600 border border-indigo-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">Workspaces</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">Ruang kerja terpadu untuk mengelola banyak proyek dan divisi tanpa tercampur.</p>
                </div>

                <!-- 3. Pengumuman -->
                <div
                    class="group p-8 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="mb-5 w-12 h-12 rounded-xl bg-amber-50 text-amber-600 border border-amber-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">Pengumuman</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">Broadcast info penting ke seluruh anggota tim secara cepat dan terorganisir.</p>
                </div>

                <!-- 4. Kanban Tugas -->
                <div
                    class="group p-8 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="mb-5 w-12 h-12 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">Kanban Tugas</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">Kelola siklus tugas dari To Do, In Progress, hingga Done dengan drag-and-drop.</p>
                </div>

                <!-- 5. Chat Tim -->
                <div
                    class="group p-8 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="mb-5 w-12 h-12 rounded-xl bg-purple-50 text-purple-600 border border-purple-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">Chat Terpadu</h3>
                ...
                <div
                    class="group p-8 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="mb-5 w-12 h-12 rounded-xl bg-rose-50 text-rose-600 border border-rose-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">Statistik Tim</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">Laporan metrik performa, penyelesaian task, dan produktivitas tim lengkap.</p>
                </div>

                <!-- 8. Dokumen -->
                <div
                    class="group p-8 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="mb-5 w-12 h-12 rounded-xl bg-teal-50 text-teal-600 border border-teal-100 flex items-center justify-center">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                    </div>
                    <h3 class="text-lg font-bold mb-2 text-slate-900">Dokumen & Preview</h3>
                    <p class="text-sm text-slate-500 leading-relaxed">Pusat file proyek lengkap dengan fitur pratinjau dokumen langsung di browser.</p>
                </div>
            </div>

            <div
                class="text-center bg-gradient-to-r from-blue-700 to-blue-800 p-10 rounded-2xl shadow-xl max-w-2xl mx-auto transform hover:-translate-y-0.5 transition-all duration-300">
                <h3 class="text-2xl md:text-3xl font-extrabold text-white mb-3">
                    Dapatkan Semua Fitur Ini Gratis!
                </h3>
                <p class="text-blue-100 mb-6 font-medium text-base">Coba selama 7 hari tanpa biaya apapun</p>
                <a href="{{ route('daftar') }}">
                    <button
                        class="px-8 py-3.5 bg-white text-blue-700 rounded-full text-sm font-bold hover:bg-blue-50 shadow-xl hover:-translate-y-0.5 transition-all duration-200">
    ...
    <section id="paket" class="py-20 bg-white">
        <div class="container mx-auto px-4 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <!-- Basic Plan -->
                <div
                    class="bg-white rounded-2xl shadow-lg hover:shadow-xl p-8 border-2 border-gray-200 hover:border-blue-500 transform hover:-translate-y-1 transition-all duration-300">
                    <h3 class="text-2xl font-bold mb-4 text-gray-800">Starter</h3>
                    <div class="mb-6">
                        <div class="text-gray-400 line-through text-sm font-semibold mb-1">Rp
                            {{ number_format($basicPrice * 2, 0, ',', '.') }}</div>
                        <span class="text-3xl font-extrabold text-blue-600">Rp
                            {{ number_format($basicPrice, 0, ',', '.') }}</span>
                        <span class="text-gray-500 text-sm">/ bulan</span>
                    </div>
                    <a href="{{ route('daftar') }}">
                        <button
                            class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold shadow-md hover:shadow-lg transition-all duration-200 mb-6">
                            Coba Versi Trial Dulu
                        </button>
                    </a>
                    <div class="space-y-3">
                        <p class="font-bold text-gray-900 mb-4 text-sm">Benefit:</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Dapat 5 pengguna</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Akses semua fitur</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Penyimpanan Unlimited</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Tim & Proyek tanpa batas</p>
                    </div>
                </div>

                <!-- Standard Plan -->
                <div
                    class="bg-blue-700 rounded-2xl shadow-xl p-8 transform md:scale-105 hover:-translate-y-1 transition-all duration-300 text-white border-2 border-blue-600 relative">
                    <div
                        class="bg-yellow-400 text-blue-950 text-xs font-black px-3.5 py-1 rounded-full inline-block mb-4 shadow-sm">
                        POPULER</div>
                    <h3 class="text-2xl font-bold mb-4">Team</h3>
                    <div class="mb-6">
                        <div class="text-blue-200 line-through text-sm font-semibold mb-1">Rp
                            {{ number_format($standardPrice * 2, 0, ',', '.') }}</div>
                        <span class="text-3xl font-extrabold text-white">Rp {{ number_format($standardPrice, 0, ',', '.') }}</span>
                        <span class="text-blue-100 text-sm">/ bulan</span>
                    </div>
                    <a href="{{ route('daftar') }}">
                        <button
                            class="w-full py-3 bg-white text-blue-700 rounded-full font-bold hover:bg-blue-50 shadow-lg hover:shadow-xl transition-all duration-200 mb-6">
                            Coba Versi Trial Dulu
                        </button>
                    </a>
                    <div class="space-y-3">
                        <p class="font-bold text-white mb-4 text-sm">Benefit:</p>
                        <p class="text-blue-50 text-sm flex items-center gap-2"><span class="text-yellow-300 font-bold">✓</span> Dapat 15 pengguna</p>
                        <p class="text-blue-50 text-sm flex items-center gap-2"><span class="text-yellow-300 font-bold">✓</span> Akses semua fitur</p>
                        <p class="text-blue-50 text-sm flex items-center gap-2"><span class="text-yellow-300 font-bold">✓</span> Penyimpanan Unlimited</p>
                        <p class="text-blue-50 text-sm flex items-center gap-2"><span class="text-yellow-300 font-bold">✓</span> Tim & Proyek tanpa batas</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="space-y-3">
                        <p class="font-bold text-gray-900 mb-4 text-sm">Benefit:</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Dapat 50 pengguna</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Akses semua fitur</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Penyimpanan Unlimited</p>
                        <p class="text-gray-700 text-sm flex items-center gap-2"><span class="text-emerald-500 font-bold">✓</span> Tim & Proyek tanpa batas</p>
                    </div>
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="max-w-3xl mx-auto">
                <div class="text-center mb-12">
                    <div
                        class="inline-block bg-blue-500/20 border border-blue-400/30 px-5 py-1.5 rounded-full text-blue-300 font-bold text-xs uppercase tracking-wider mb-4">
                        Feedback & Masukan
                    </div>
                    <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-3">
                        Beri Masukan untuk Koladi
                    </h2>
                    <p class="text-base sm:text-lg text-slate-300">Bantu kami menjadi lebih baik! Suara Anda sangat berarti</p>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-2xl p-8 md:p-12 shadow-2xl border border-white/20">
                    <form action="{{ route('feedback.store') }}" method="POST" class="space-y-6">
                        @csrf
                        <div>
                            <label class="block text-white font-bold mb-3 text-sm">Nama Anda (Opsional)</label>
                            <input type="text" name="name" placeholder="Masukkan nama Anda..."
                                class="w-full px-5 py-3.5 rounded-xl border border-white/30 bg-white/10 text-white placeholder-white/50 focus:border-blue-400 focus:outline-none transition-colors backdrop-blur-sm text-sm">
                        </div>

                        <div>
                            <label class="block text-white font-bold mb-3 text-sm">Email (Opsional)</label>
                            <input type="email" name="email" placeholder="email@example.com"
                                class="w-full px-5 py-3.5 rounded-xl border border-white/30 bg-white/10 text-white placeholder-white/50 focus:border-blue-400 focus:outline-none transition-colors backdrop-blur-sm text-sm">
                        </div>

                        <div>
                            <label class="block text-white font-bold mb-3 text-sm">Masukan Anda</label>
                            <textarea name="message" rows="5"
                                placeholder="Ceritakan pengalaman Anda, saran, atau fitur yang Anda inginkan..."
                                class="w-full px-5 py-3.5 rounded-xl border border-white/30 bg-white/10 text-white placeholder-white/50 focus:border-blue-400 focus:outline-none transition-colors resize-none backdrop-blur-sm text-sm"></textarea>
                        </div>
                        <button type="submit"
                            class="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-base font-bold
             ...
             animate-[pop_180ms_ease-out]">
                ...
                <div class="mt-12 text-center bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
                    <p class="text-white text-lg font-bold mb-4">Atau langsung coba Koladi secara gratis!</p>
                    <a href="{{ route('daftar') }}">
                        <button
                            class="px-8 py-3.5 bg-white text-blue-700 rounded-full text-sm font-bold hover:bg-blue-50 shadow-xl hover:-translate-y-0.5 transition-all duration-200">
                    ...
                    <p class="text-blue-200 mt-4 text-xs font-medium">Tanpa kartu kredit • Batalkan kapan saja • Setup mudah
                    </p>
                </div>
            </div>
        </div>
