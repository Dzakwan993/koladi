                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <button @click="openPopup = true"
                                class="mt-2 bg-[#2563eb] text-white font-semibold py-1 px-2 rounded-lg text-sm hover:bg-blue-700 transition-colors flex items-center gap-1 ">
                ...
                <div class="flex items-start gap-2">
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex gap-2 mt-2">
                            <button
                                class="bg-blue-600 text-white w-[80px] h-[30px] rounded-md hover:bg-blue-700 transition">Kirim</button>
                            <button
                                class="border border-blue-600 text-blue-600 w-[80px] h-[30px] rounded-md hover:bg-blue-50 transition">Batal</button>
                        </div>
