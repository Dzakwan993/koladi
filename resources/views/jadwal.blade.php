...
<div class="flex flex-col items-center w-[120px] date-section">
  ...
  <div class="flex flex-col flex-1 px-4 content-section">
    ...
    <div class="flex items-center gap-2">
      ...
      <span class="font-semibold text-[#090909] text-base">Pengumuman Darurat</span>
    </div>

    <!-- Jam + Profil sejajar -->
    <div class="flex items-center gap-2 mt-1">
      <img src="{{ asset('images/dk.jpg') }}" class="w-6 h-6 rounded-full" alt="Profile">
...
.fc .fc-daygrid-day-events {
    display: none !important; /* hilangkan seluruh event container */
}
.fc .fc-daygrid-event {
    background: transparent !important;
    border: none !important;
...
.fc .fc-daygrid-day-frame {
    position: relative;
    overflow: visible !important; /* biar marker tidak terpotong */
}

/* Marker kuning dengan angka di dalam */
.fc .day-marker {
    position: absolute;
    top: 0px;           /* posisi di atas angka tanggal */
    left: 65%;
    width: 16px;        /* lingkaran lebih besar supaya muat angka */
    height: 16px;
    ...
    align-items: center;
    justify-content: center;
    font-size: 10px;    /* ukuran angka */
    color: #6B7280;     /* warna angka di lingkaran */
    font-weight: 600;
    font-family: inter: sans-serif
    pointer-events: none;
    z-index: 10;
