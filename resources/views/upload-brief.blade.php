                        ...
                        <div class="p-6 max-h-[65vh] overflow-y-auto space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    class="w-full text-sm border border-slate-200 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none resize-y text-slate-800"
                                ></textarea>
                            </div>

                            {{-- Field 3: Periode Projek --}}
                            <div>
                                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-1.5">
                                    Periode Projek
                                </label>
                                <input
                                    ...
                                    placeholder="Contoh: 3 Bulan (1 Sep 2026 - 30 Nov 2026)"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    placeholder="Rincian modul, batasan pekerjaan, dan tahapan eksekusi..."
                                    class="w-full text-sm border border-slate-200 rounded-xl px-3.5 py-2.5 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none resize-y text-slate-800"
                                ></textarea>
                            </div>
                        </div>
...
<script>
    ...
    function uploadBriefComponent() {
        return {
            ...
            editCurrentTemplate() {
                this.formTemplate = { ...this.selectedTemplate };
                this.templateStep = 2;
                this.showTemplateModal = true;
            },
            ...
            clearSelectedTemplate() {
                ...
                this.selectedTemplate = { name: '', goal: '', period: '', deliverables: '', scope: '' };
                const fileInput = document.getElementById('fileInput');
                if (fileInput) {
