        ...
        <div class="max-w-7xl mx-auto h-full flex flex-col">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-2 mb-4 flex-shrink-0">
                ...
                <button onClick="openInviteModal(event)"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2.5 rounded-lg font-medium transition flex items-center justify-center gap-1 shadow-sm">
            ...
            <div class="flex-1 overflow-y-auto flex flex-col gap-2">
                ...
                {{-- User Card 1 --}}
                <div
                    class="border-2 border-gray-200 bg-white rounded-xl p-4 flex items-center justify-between shadow-sm hover:shadow-md transition">
                    ...
                    <button onclick="openDeleteModal(event)"
                        class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg font-medium transition flex items-center gap-2">
