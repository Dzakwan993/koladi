...
<div class="px-5">
  <div class="bg-white rounded-2xl shadow-lg w-full mx-auto mt-6 mb-1 p-5 flex flex-col justify-center font-inter space-y-2 border border-gray-200">
    <!-- Judul -->
    ...
    <p class="text-gray-800 text-sm leading-relaxed">
      Terlihat sepertinya <span class="font-medium text-blue-600">Jokowi</span> kurang maksimal kerjanya, coba evaluasi dia ya!
  ...
  <div class="project-info">
    ...
    <p class="text-sm text-gray-500">Status/Deskripsi singkat</p>
        ...
        <div class="flex justify-center mt-6">
          <div class="border-2 border-blue-500 rounded-xl px-6 py-4 bg-white shadow-sm w-[280px] flex flex-col items-center">
            ...
            <div class="flex justify-center items-center space-x-2">
              ...
              @for ($i = 1; $i <= 5; $i++)
                @if ($i <= $rating)
                  <span>
                    <img src="images/icons/Star.svg" alt="Bintang Kuning" style="width:30px; height:30px;">
                  </span>
                @else
                  <span>
                    <img src="images/icons/Star1.svg" alt="Bintang Abu" style="width:30px; height:30px;">
                  </span>
                @endif
              @endfor
            </div>
      ...
      <!-- Chart Card -->
      <div style="background:#fff; border-radius:16px; padding:20px; box-shadow:0 4px 10px rgba(0,0,0,0.1); width:420px; margin-left:80px;">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; gap:10px; padding:30px;">
          <div style="flex-shrink:0;">
            <svg viewBox="0 0 200 200" style="width:140px; height:140px;">
              ...
              <circle cx="100" cy="100" r="80" fill="none" stroke="#2563eb" stroke-width="35" stroke-dasharray="80 402.4" stroke-dashoffset="0" transform="rotate(-90 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" stroke="#6B7280" stroke-width="35" stroke-dasharray="120 362.4" stroke-dashoffset="-80" transform="rotate(-90 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" stroke="#facc15" stroke-width="35" stroke-dasharray="60 422.4" stroke-dashoffset="-200" transform="rotate(-90 100 100)" />
              <circle cx="100" cy="100" r="80" fill="none" stroke="#40c79a" stroke-width="35" stroke-dasharray="142.4 340" stroke-dashoffset="-260" transform="rotate(-90 100 100)" />
              <text x="100" y="110" text-anchor="middle" font-size="20" fill="#374151" font-weight="bold">100%</text>
            </svg>
          </div>

          <div style="display:flex; flex-direction:column; gap:8px; font-size:14px; color:#374151; padding:10px; justify-content:center; align-items:flex-start; height:100%;">
...
<p class="text-lg font-bold text-black font-inter" style="size:16px; padding:5px;">Rekap Kerja</p>
  <div class="search-box-wrapper" style="position:relative; margin-bottom:14px;">
    ...
    <span class="search-icon" style="position:absolute; right:8px; top:50%;"><img src="images/icons/Arrow.svg" alt=""></span>
  </div>

  <div class="section-title" style="font-size:14px; font-weight:600; color:#374151; margin-bottom:8px;">Cari workspace</div>
  <div class="search-box-wrapper" style="position:relative; margin-bottom:14px;">
    <input type="text" class="search-box" placeholder="Cari..."
           style="width:100%; padding:6px 28px 6px 8px; border:1px solid #d1d5db; border-radius:8px;">
    <span class="search-icon" style="position:absolute; right:8px; top:50%; transform:translateY(-50%);"><img src="images/icons/Search.svg" alt=""></span>
  </div>
 ...
 <div class="workspace-list" style="display:flex; flex-direction:column; gap:8px; margin-bottom:16px;">
  ...
  <div class="workspace-item"
    ...
    <img src="images/icons/BlueHQ .svg" alt="HQ Icon" style="width:28px; height:28px; object-fit:contain;">
  ...
  <div class="workspace-item"
       style="display:flex; align-items:center; gap:8px; padding:8px; border-radius:8px; cursor:pointer; background:#f9fafb; transition:0.2s; border:1px solid #e5e7eb;"
       onclick="selectWorkspace(this)">
    <img src="images/icons/BlueTim.svg" alt="Tim Icon" style="width:28px; height:28px; object-fit:contain;">
  ...
  <div class="workspace-item"
       style="display:flex; align-items:center; gap:8px; padding:8px; border-radius:8px; cursor:pointer; background:#f9fafb; transition:0.2s; border:1px solid #e5e7eb;"
       onclick="selectWorkspace(this)">
    <img src="images/icons/BlueProyek.svg" alt="Proyek Icon" style="width:28px; height:28px; object-fit:contain;">
...
<script>
  ...
  <div class="section-title" style="font-size:14px; font-weight:600; color:#374151; margin-bottom:8px;">Cari anggota</div>
...
">
  ...
  ">
    <div style="flex: 1;">
      ...
      <div style="font-size: 13px; color: #475569; margin-top: 4px; max-width: 280px; line-height: 1.4;">
  Menargetkan penjualan di atas 40% sehingga terjadi kenaikan penjualan
</div>

      <div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
        <div style="display: flex;">
          <img src="https://i.pravatar.cc/24?img=1" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white;">
          <img src="https://i.pravatar.cc/24?img=2" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white; margin-left: -6px;">
          <img src="https://i.pravatar.cc/24?img=3" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white; margin-left: -6px;">
        </div>
...
<script>
  ...
  Menargetkan penjualan di atas 40% sehingga terjadi kenaikan penjualan
      ...
      <div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
        <div style="display: flex;">
          <img src="https://i.pravatar.cc/24?img=4" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white;">
          <img src="https://i.pravatar.cc/24?img=5" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white; margin-left: -6px;">
          <img src="https://i.pravatar.cc/24?img=6" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white; margin-left: -6px;">
        </div>
        <span style="font-size: 12px; color: #64748b;">Sahroni dan 3 lainnya</span>
      </div>
    </div>
...
<script>
  ...
  Menargetkan penjualan di atas 40% sehingga terjadi kenaikan penjualan
      ...
      <div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
        <div style="display: flex;">
          <img src="https://i.pravatar.cc/24?img=7" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white;">
          <img src="https://i.pravatar.cc/24?img=8" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white; margin-left: -6px;">
          <img src="https://i.pravatar.cc/24?img=9" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid white; margin-left: -6px;">
        </div>
        <span style="font-size: 12px; color: #64748b;">Sahroni dan 3 lainnya</span>
      </div>
    </div>
