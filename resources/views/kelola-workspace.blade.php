...
@section('content')
    <div class="p-6" x-data="{
        ...
        selectedMembers: [],
        members: [
            { id: 1, name: 'Ahmad Wijaya', email: 'ahmad@company.com', avatar: 'https://i.pravatar.cc/32?img=11' },
            { id: 2, name: 'Siti Nurhaliza', email: 'siti@company.com', avatar: 'https://i.pravatar.cc/32?img=12' },
            { id: 3, name: 'Budi Santoso', email: 'budi@company.com', avatar: 'https://i.pravatar.cc/32?img=13' },
            { id: 4, name: 'Dewi Lestari', email: 'dewi@company.com', avatar: 'https://i.pravatar.cc/32?img=14' },
            { id: 5, name: 'Rizki Pratama', email: 'rizki@company.com', avatar: 'https://i.pravatar.cc/32?img=15' },
            { id: 6, name: 'Maya Sari', email: 'maya@company.com', avatar: 'https://i.pravatar.cc/32?img=16' },
            { id: 7, name: 'Fajar Nugroho', email: 'fajar@company.com', avatar: 'https://i.pravatar.cc/32?img=17' },
            { id: 8, name: 'Indah Permata', email: 'indah@company.com', avatar: 'https://i.pravatar.cc/32?img=18' },
