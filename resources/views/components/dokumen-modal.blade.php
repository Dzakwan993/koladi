...
{{-- Modal Pindah Berkas --}}
<div x-show="showMoveDocumentsModal" x-cloak @movemodal-open.window="loadAvailableWorkspaces()"
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] flex flex-col"
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex-shrink-0">
            <h3 class="text-lg font-semibold text-gray-800">Pindahkan Dokumen</h3>
        </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-blue-700 mt-1">
                            Dari: <span class="font-medium"
                                x-text="currentWorkspace?.name || 'Workspace Saat Ini'"></span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div x-show="!loadingWorkspaces" class="space-y-4">
                ...
                <div>
                    ...
                    <div x-show="availableWorkspaces.length === 0"
                        ...
                        <p class="text-sm text-gray-600">Tidak ada workspace lain tersedia</p>
                    </div>
                ...
                <div x-show="selectedWorkspace" x-transition class="space-y-3">
                    ...
                    {{-- Folder & File List (seperti file explorer) --}}
...
{{-- ============================================ --}}
{{-- Modal Tambah Link (Workspace Context)        --}}
{{-- ============================================ --}}
<div x-show="showModalLink" x-cloak
    ...
    <div class="bg-white rounded-xl w-full max-w-md shadow-2xl" @click.outside="showModalLink = false">
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('workspace.link.store') }}"
