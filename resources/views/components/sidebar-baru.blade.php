...
<div x-data="{ openSidebar: window.innerWidth >= 992 }" 
     x-init="const handleResize = () => {
    ...
    <div x-show="openSidebar"
        ...
        <nav class="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
            ...
            {{-- ✅ 7. AI Brief (Disabled - Belum Ada Halaman) --}}
            <a href="#"
                class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 cursor-not-allowed relative group"
                ...
                {{-- Badge "Segera" --}}
                <span class="absolute right-2 top-1/2 -translate-y-1/2 px-1.5 py-0.5 text-[10px] font-medium bg-gray-200 text-gray-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                    Segera
                </span>
            </a>
...
@endif
    ...
    <div x-show="openSidebar && window.innerWidth < 768" 
