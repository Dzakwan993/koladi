...
<div x-show="viewMode === 'kanban'" class="h-full">
                ...
                <div class="bg-blue-100 rounded-lg kanban-padding-medium kanban-column-medium flex-shrink-0 flex flex-col">
                    ...
                    <div class="flex items-center justify-between mb-1 xs:mb-2">
                        <div class="flex items-center gap-2">
                            <h2 class="font-semibold text-gray-700 text-xs xs:text-sm sm:text-base" x-text="column.name"></h2>
                        ...
                        <button 
                            x-show="!['To Do List', 'Dikerjakan', 'Selesai', 'Batal'].includes(column.name)"
    ...
    class="secret-task-badge ml-2 flex-shrink-0 inline-flex items-center gap-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-2 py-1 rounded-full text-xs font-semibold">
                                            ...
                                            {{-- Badge Terlambat (dikomentari) --}}
                                            {{-- 
                                            <span x-show="task.is_overdue" class="ml-2 ...">Terlambat</span> 
                                            --}}
                                        </div>
                                    </div>

                                    {{-- TITLE --}}
                                    <p class="font-medium text-gray-800 mb-1 xs:mb-2 line-clamp-2"
                                        x-text="task.title"></p>
                                    ...
                                    <div class="flex items-center justify-between mb-1 xs:mb-2">
                                        ...
                                        <div x-show="task.labels?.length > 0" class="flex flex-wrap gap-1 justify-end">
                                            ...
                                            <span x-show="task.labels.length > 2"
            ...
            <div class="flex items-start justify-center pr-2 xs:pr-3">
                <button @click="openModal = true"
                    ...
                    <svg class="h-3 w-3 xs:h-4 xs:w-4" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="2">
