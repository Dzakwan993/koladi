    ...
    <nav class="flex-1 py-4 px-3 space-y-1 overflow-auto">
        ...
        <div class="pt-3 mt-3 border-t border-gray-200">
            <div class="flex items-center gap-2">
                <!-- Kolom Pencarian -->
                <div
                    class="flex items-center gap-2 px-2 py-1    rounded-lg bg-gray-50 text-gray-400 text-xs flex-1 min-w-0 hover:text-gray-600 transition">
                ...
                <button
                    class="flex items-center justify-center w-8 h-8 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition flex-shrink-0">
        ...
        <div class="mt-3 space-y-0.5" x-data="{ openHQ: true, openTim: true, openProyek: true }">
            ...
            <div class="px-3 py-1.5">
                <div class="flex items-center justify-between text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                    ...
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <!-- Panah kanan -->
                        <path x-show="!openHQ" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
                        <!-- Panah bawah -->
                        <path x-show="openHQ" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-show="openHQ" class="space-y-0.5 mt-1">
                <a href="#"
                    class="flex items-center gap-2 px-6 py-1.5 text-sm text-gray-600 hover:bg-gray-50 rounded transition">
            ...
            <div class="px-3 py-1.5 mt-2">
                <div class="flex items-center justify-between text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                    ...
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <!-- Panah kanan -->
                        <path x-show="!openTim" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
                        <!-- Panah bawah -->
                        <path x-show="openTim" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 9l-7 7-7-7"></path>
            ...
            <div x-show="openTim" class="space-y-0.5 mt-1">
                <a href="#"
                    class="flex items-center gap-2 px-6 py-1.5 text-sm text-blue-600 bg-blue-50 font-medium rounded transition">
            ...
            <div class="px-3 py-1.5 mt-2">
                <div class="flex items-center justify-between text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer"
                    ...
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <!-- Panah kanan -->
                        <path x-show="!openProyek" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
                        <!-- Panah bawah -->
                        <path x-show="openProyek" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 9l-7 7-7-7"></path>
