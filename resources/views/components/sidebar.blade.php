<div class="w-64 bg-white shadow-sm flex flex-col border-r border-gray-200 h-screen">
    ...
    <div class="h-16 flex items-center justify-center px-4 border-b border-gray-200">
        <img src="{{ asset('images/logo-koladi.png') }}" class="h-12 w-auto object-contain">
    </div>
    ...
    <nav class="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
        ...
        <a href="{{ url('/workspace') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50 transition">
            <img src="{{ asset('images/ruang-kerja.svg') }}" alt="Ruang Kerja" class="w-5 h-5 flex-shrink-0 object-contain">
            <span class="text-sm">Ruang Kerja</span>
        </a>

        {{-- Laporan Kinerja --}}
        <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50 transition">
            <img src="{{ asset('images/kinerja.svg') }}" alt="Laporan Kinerja" class="w-5 h-5 flex-shrink-0 object-contain">
        ...
        <div class="pt-3 mt-3 border-t border-gray-200">
            <div class="flex items-center gap-2">
                {{-- Search Input --}}
                <div class="flex items-center gap-2 px-2.5 py-2 rounded-lg bg-gray-50 text-gray-400 text-xs flex-1 min-w-0 hover:bg-gray-100 transition">
                ...
                {{-- Filter Button --}}
                <button class="flex items-center justify-center w-9 h-9 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-50 transition flex-shrink-0">
        ...
        <div class="mt-3 space-y-1" x-data="{ openHQ: true, openTim: true, openProyek: true }">
            ...
            <div>
                <button @click="openHQ = !openHQ"
                    ...
                    <div class="flex items-center gap-2">
                        <img src="{{ asset('images/hq.svg') }}" alt="HQ" class="w-4 h-4 flex-shrink-0 object-contain">
                        <span>HQ</span>
                    </div>
                    <svg class="w-3 h-3 transition-transform flex-shrink-0" :class="{ 'rotate-90': openHQ }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </button>

                <div x-show="openHQ" x-transition class="mt-1 space-y-0.5">
                    <a href="#" class="flex items-center gap-2.5 px-6 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg transition">
            ...
            <div>
                <button @click="openTim = !openTim"
                        class="w-full flex items-center justify-between px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider hover:bg-gray-50 rounded-lg transition">
                    <div class="flex items-center gap-2">
                        <img src="{{ asset('images/tim.svg') }}" alt="Tim" class="w-4 h-4 flex-shrink-0 object-contain">
                        <span>Tim</span>
                    </div>
                    <svg class="w-3 h-3 transition-transform flex-shrink-0" :class="{ 'rotate-90': openTim }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </button>
            ...
            <div>
                <button @click="openProyek = !openProyek"
                        class="w-full flex items-center justify-between px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider hover:bg-gray-50 rounded-lg transition">
                    <div class="flex items-center gap-2">
                        <img src="{{ asset('images/proyek.svg') }}" alt="Proyek" class="w-4 h-4 flex-shrink-0 object-contain">
                        <span>Proyek</span>
                    </div>
                    <svg class="w-3 h-3 transition-transform flex-shrink-0" :class="{ 'rotate-90': openProyek }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                </button>
