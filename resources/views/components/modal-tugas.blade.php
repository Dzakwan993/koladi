    ...
    @click.self="openTaskDetail = false">
     ...
     <div class="bg-white w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
         ...
         <div class="overflow-y-auto flex-1 px-6 py-4">
             ...
             <!-- Komentar Section -->
             <!-- Komentar Section -->
<div class="border-t pt-4 mt-6" x-data="taskCommentSection()" x-init="init()">
    <div class="space-y-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center gap-4 mt-2">
                                    <button @click="toggleReply(comment)"
                                        ...
                                        <span>balas</span>
                                        <span x-show="comment.replies && comment.replies.length > 0" class="ml-1"
                                    ...
                                    <div class="mt-4 pl-6 border-l-2 border-gray-200">
                                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                                            ...
                                            <div class="border border-gray-300 rounded-lg overflow-hidden mb-3">
                                                <div :id="'task-reply-editor-' + comment.id" class="min-h-[100px] p-3 bg-white"></div>
                                            </div>
