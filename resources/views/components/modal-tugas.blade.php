    ...
    <div class="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b">
            ...
            <div class="mt-4 bg-blue-50 rounded-lg p-4" x-show="phaseModal.start_date || phaseModal.end_date">
                ...
                <!-- Date Range Summary -->
                <div class="mt-3 pt-3 border-t border-blue-200" x-show="phaseModal.start_date && phaseModal.end_date">
                    <div class="text-center text-sm text-blue-700 font-medium">
                        <span
                            x-text="'Phase ini berlangsung dari ' + formatDate(phaseModal.start_date) + ' hingga ' + formatDate(phaseModal.end_date)"></span>
                    </div>
                </div>
            </div>
...
<div x-show="openTaskModal && !replyView.active" x-cloak
    ...
    <div class="bg-white rounded-xl w-full max-w-3xl shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="createTask()" class="p-6 space-y-4">
            ...
            <!-- PHASE INPUT - OPSIONAL -->
            <div>
                <label class="text-sm font-medium text-gray-700 mb-2 block">
                    Fase
                    <span class="text-xs text-gray-500 ml-1">(Opsional)</span>
                </label>
                <input type="text" x-model="taskForm.phase" placeholder="Masukkan nama fase (opsional)"
                ...
                <p class="text-xs text-gray-500 mt-1">
                    💡 Tugas tanpa fase tidak akan muncul di timeline
                </p>
            </div>

            <!-- Anggota & Tugas Rahasia - OPSIONAL -->
            <div class="mb-4">
                <label class="text-sm font-medium text-gray-700 mb-2 block">
                    Anggota
                    <span class="text-xs text-gray-500 ml-1">(Opsional)</span>
                ...
                <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
                    ...
                    <div x-show="isEditMode" class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p class="text-xs text-blue-700">
                            💡 Label akan disimpan setelah Anda klik <strong>"Simpan Perubahan"</strong> di halaman
                            detail tugas.
                        </p>
                    </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" x-model="taskForm.startDate" required
                ...
                <div>
                    ...
                    <input type="time" x-model="taskForm.startTime" required
                        class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Tenggat <span class="text-red-500">*</span>
                    </label>
                    <input type="date" x-model="taskForm.dueDate" required
                        class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        Jam Tenggat <span class="text-red-500">*</span>
                    </label>
                    <input type="time" x-model="taskForm.dueTime" required
                        class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500" />
                </div>
            </div>
                        ...
                        <div class="flex items-center justify-between border border-gray-300 rounded-lg p-3">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-700" x-text="file.name || 'Unknown File'">
                                    </p>
            ...
            <div class="mb-4">
                ...
                <div class="space-y-2 border border-gray-300 rounded-lg p-3" id="detail-checklist-container">
                    <template x-for="(item, index) in currentTask?.checklist || []" :key="item.id">
                        <div class="flex items-center gap-2">
                            <input type="checkbox" x-model="item.is_done" @change="updateChecklistItemInDetail(item)"
