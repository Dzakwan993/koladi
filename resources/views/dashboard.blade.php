...
@section('content')
<div class="px-3 pt-2 pb-3 sm:p-6 lg:p-8 h-screen overflow-hidden">
    <div class="max-w-7xl mx-auto h-full flex flex-col">
        {{-- Header - Fixed Height --}}
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-gray-200 pb-1.5 mb-2 flex-shrink-0">
            <div class="mx-3">
                <h1 class="text-2xl sm:text-xl font-bold text-gray-900">Selamat datang, Sahroni</h1>
                <p class="text-base text-gray-600 mt-1">Silahkan kelola tugas anda.</p>
            </div>
            <button class="mx-4 text-sm bg-blue-600 hover:bg-blue-700 text-white px-3 py-2.5 rounded-lg font-medium transition flex items-center justify-center gap-1 shadow-sm">
                <img src="{{ asset('images/icons/Plus.svg') }}" alt="Schedule" class="w-6 h-6" />
                Tambah anggota
            </button>
        </div>

        {{-- Main Grid - Flex 1 to fill remaining space --}}
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-3" style="height: calc(100vh - 100px);">
        {{-- Left Column - Tasks --}}
<div class="flex flex-col mx-3 h-full overflow-hidden">
    ...
    <div class="bg-white rounded-xl shadow-sm px-6 py-4 flex-1 flex flex-col overflow-hidden">
        {{-- Header: Judul + Search + Sort --}}
        <div class="mb-2 flex-shrink-0">
            <div class="flex items-center gap-3">
                {{-- Judul Perencanaan --}}
                <h2 class="text-lg font-bold text-gray-700">Perencanaan</h2>
                {{-- Search Box --}}
                <div class="flex-1 relative">
                    <input 
                        type="text" 
                        placeholder="Cari tugas..." 
                        class="w-full pl-10 pr-4 py-1.5 bg-gray-100 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm placeholder-gray-400"
                    />
        ...
        {{-- Divider --}}
        <div class="border-t border-black mb-2 flex-shrink-0"></div>

        {{-- Scroll Container dengan Cards --}}
        <div class="flex-1 overflow-hidden">
            ...
            <div class="flex flex-col h-full overflow-visible mx-4 ">
                ...
                {{-- Task Detail --}} 
                <div class="mt-3 flex-shrink-0" style="">
                <x-scroll-card max-height="h-full">
