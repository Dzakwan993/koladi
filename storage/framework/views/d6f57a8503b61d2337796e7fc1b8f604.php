            ...
            <div class="px-4 sm:px-6 pb-4 sm:pb-6 flex-1 overflow-hidden flex">
                <div
                    ...
                    <div data-company-role-list class="space-y-2 sm:space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $usersInCompany; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-2 sm:gap-3 w-full sm:w-auto min-w-0">
                                    ...
                                    <img src="<?php echo e($avatarUrl); ?>" alt="<?php echo e($user->full_name); ?>"
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="font-semibold text-base sm:text-lg text-[#0F172A] truncate"><?php echo e($user->full_name); ?></span>
                                        <span
                                            class="text-white text-xs font-semibold px-2 sm:px-3 py-0.5 rounded-bl-2xl rounded-tr-2xl whitespace-nowrap"
                                            style="background-color: <?php echo e($roleColor); ?>">
                                            <?php echo e($roleName); ?>
                                ...
                                <?php else: ?>
                                    <div class="relative w-full sm:w-36 md:w-40">
                                        <button onclick="toggleDropdown(this)"
                                            ...
                                            data-user-id="<?php echo e($user->id); ?>" data-current-role="<?php echo e($roleName); ?>">
                                            <span
                                                class="role-text absolute left-1/2 -translate-x-1/2"><?php echo e($roleName); ?></span>
                                        ...
                                        <div
                                            ...
                                            <?php if($availableRoles->count() > 0): ?>
                                                <?php $__currentLoopData = $availableRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <button onclick="selectRole(this, '<?php echo e($role->id); ?>')"
                                                        data-role-name="<?php echo e($role->name); ?>"
                                                        class="block w-full text-left px-3 sm:px-4 py-2 text-sm sm:text-base hover:bg-blue-50 <?php echo e($loop->first ? 'rounded-t-lg' : ''); ?> <?php echo e($loop->last ? 'rounded-b-lg' : ''); ?> font-medium <?php echo e($role->name === $roleName ? 'bg-blue-50 text-blue-600' : ''); ?>">
...
<script>
    ...
    function saveRoleChanges() {
        ...
        if (ctx.type === 'company') {
            payload.company_id = '<?php echo e($activeCompany->id ?? ''); ?>';
...
<?php /**PATH C:\xampp\htdocs\koladi\resources\views/components/atur-hak.blade.php ENDPATH**/ ?>