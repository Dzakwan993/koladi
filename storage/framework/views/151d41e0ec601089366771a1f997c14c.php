    ...
    <div class="bg-[#f3f6fc] min-h-screen font-[Inter,sans-serif] text-black">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 space-y-4 max-h-[600px] overflow-y-auto custom-scrollbar">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $pengumumans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div onclick="window.location='<?php echo e(route('pengumuman-perusahaan.show', ['company_id' => $company_id, 'id' => $p->id])); ?>'"
                                    ...
                                    <div class="flex items-start justify-between mb-2">
                                        <div class="flex-1">
                                            <p class="font-semibold text-gray-800 text-sm">
                                                <?php echo e($p->creator->full_name ?? 'Unknown'); ?>
                                    ...
                                    <div class="flex items-center gap-2 flex-wrap">
                                        <?php if($p->due_date): ?>
                                            <span
                                                ...
                                                <?php echo e(\Carbon\Carbon::parse($p->due_date)->translatedFormat('d M')); ?>
        ...
        <div id="popupForm" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden items-center justify-center z-50 p-4">
            <div class="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto custom-scrollbar">
                ...
                <form action="<?php echo e(route('pengumuman-perusahaan.store', ['company_id' => $company_id])); ?>" method="POST"
                                    ...
                                    input.addEventListener('change', async (e) => {
                                        ...
                                        try {
                                            const res = await fetch('/upload-image', {
                                                method: 'POST',
                                                headers: {
                                                    'X-CSRF-TOKEN': csrfToken || '<?php echo e(csrf_token()); ?>'
                                                },
                                                body: formData
                                            });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\koladi\resources\views/pengumuman-perusahaan.blade.php ENDPATH**/ ?>