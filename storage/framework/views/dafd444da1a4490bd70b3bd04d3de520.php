<div class="h-16 bg-white shadow-sm flex items-center px-6 justify-between border-b border-gray-200">
    ...
    <div class="flex items-center gap-3">
        <img src="<?php echo e(asset('images/logo-pt.svg')); ?>" alt="Logo PT" class="h-8 w-8">
        <span class="text-gray-600 font-medium whitespace-nowrap">
            <?php echo e($activeCompany->name ?? 'Belum ada perusahaan'); ?>
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2" x-data="activeUsersComponent" x-init="init('<?php echo e($activeCompany->id ?? ''); ?>')">
        ...
        <button class="p-1 hover:bg-gray-50 rounded-lg transition" title="Atur Akses"
            ...
            <img src="<?php echo e(asset('images/icons/akses.svg')); ?>" alt="Atur Akses" class="w-5 h-5">
        </button>

        <a href="javascript:void(0)" onclick="checkSuperAdminAccess()"
            class="p-2 hover:bg-gray-100 rounded-lg transition" title="Dollar">
            <img src="<?php echo e(asset('images/icons/dollar.svg')); ?>" alt="Dollar" class="w-5 h-5">
        </a>
        <!-- Tombol Notifikasi -->
        <div class="relative" x-data="{ showNotifications: false }">
            <button @click="showNotifications = true" class="p-2 hover:bg-gray-100 rounded-lg transition relative"
                title="Notifikasi">
                <img src="<?php echo e(asset('images/icons/notifikasi.svg')); ?>" alt="Notifikasi" class="w-5 h-5">
                <!-- Unread Badge -->
        ...
        <script>
            function checkSuperAdminAccess() {
                window.location.replace('<?php echo e(url('/pembayaran')); ?>');
            }
        ...
        <div class="relative" x-data="{ openCompany: false }">
            <button @click="openCompany = !openCompany" class="p-2 hover:bg-gray-100 rounded-lg transition"
                title="Perusahaan">
                <img src="<?php echo e(asset('images/icons/kantor.svg')); ?>" alt="Perusahaan" class="w-5 h-5">
            </button>
            ...
            <div x-show="openCompany" @click.away="openCompany = false"
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div x-data="{ showModal: false, showConfirm: false }" class="relative">
                            ...
                            <div class="flex items-center justify-between px-4 py-3 hover:bg-gray-50 transition group">
                                ...
                                <a href="<?php echo e(route('company.switch', $company->id)); ?>"
                                    ...
                                    <span class="text-sm font-medium text-gray-700"><?php echo e($company->name); ?></span>
                                </a>

                                
                                <div class="flex items-center gap-2 ml-3">
                                    
                                    <?php if($isSuperAdminForCompany): ?>
                                        <button type="button" @click.stop="showModal = true"
                                            class="hover:opacity-80 transition" title="Edit Perusahaan (Super Admin)">
                                            <img src="<?php echo e(asset('images/icons/pengaturan.svg')); ?>" alt="Pengaturan"
                                                class="w-5 h-5 cursor-pointer">
                                        </button>
                                    <?php endif; ?>

                                    <?php if($activeCompany && $company->id == $activeCompany->id): ?>
                                        <img src="<?php echo e(asset('images/icons/centang.svg')); ?>" alt="Active"
                                            class="w-5 h-5">
                                    <?php endif; ?>
                                </div>
                            </div>
                                ...
                                <div x-show="showModal"
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-center mb-6">
                                            <img src="<?php echo e(asset('images/pengaturan-perusahaan.svg')); ?>" alt="Kantor"
                                        ...
                                        <form action="<?php echo e(route('company.update', $company->id)); ?>" method="POST">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <input type="text" name="name" value="<?php echo e($company->name); ?>"
                ...
                <div class="border-t border-gray-200">
                    <a href="<?php echo e(url('buat-perusahaan')); ?>"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 flex-wrap">
                                <h4 class="font-semibold text-gray-900 text-base"><?php echo e($user->full_name); ?></h4>
                            </div>
                            <span
                                class="inline-block bg-[#225ad6] text-white text-xs font-semibold px-2.5 py-1 rounded mt-1">
                                <?php echo e($user->getRoleName($activeCompany->id) ?? 'Tanpa Role'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\koladi\resources\views/components/topbar.blade.php ENDPATH**/ ?>