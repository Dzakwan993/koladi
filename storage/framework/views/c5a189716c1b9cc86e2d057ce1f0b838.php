        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
            ...
            <div class="flex justify-center mb-6">
                <div class="flex items-center">
                    <img src="<?php echo e(asset('images/logo-koladi1.png')); ?>" alt="Logo Koladi" class="h-12">
                </div>
            </div>
            ...
            <form class="space-y-4" action="<?php echo e(url('/masuk')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" placeholder="Alamat email" value="<?php echo e(old('email')); ?>"
            ...
            3l18 18" />
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center text-sm gap-2 sm:gap-0">
                    <a href="<?php echo e(route('forgot-password')); ?>" class="text-blue-600 font-semibold hover:underline">Lupa kata sandi?</a>
                    <div class="text-center sm:text-right">
                        <span class="text-gray-500">Belum punya akun? </span>
                        <a href="<?php echo e(url('/daftar')); ?>" class="text-blue-600 font-semibold hover:underline">Daftar</a>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\koladi\resources\views/auth/masuk.blade.php ENDPATH**/ ?>