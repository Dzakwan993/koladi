<script>
    ...
    <?php if(session('alert')): ?>
        ...
        <?php echo $__env->make('components.sweet-alert-style', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
    ...
    <?php if($errors->any()): ?>
        ...
        <?php echo $__env->make('components.sweet-alert-style', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><?php /**PATH C:\xampp\htdocs\koladi\resources\views/components/sweet-alert.blade.php ENDPATH**/ ?>