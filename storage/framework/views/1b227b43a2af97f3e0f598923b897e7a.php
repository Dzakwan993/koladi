            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-5 border border-white/20">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                    ...
                    <div class="relative">
                        ...
                        <img src="<?php echo e($currentUserAvatar); ?>"
                             alt="<?php echo e($currentUser->full_name); ?>"
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        <h3 class="text-xl sm:text-2xl text-white font-bold mb-2">
                            <?php echo e($currentUser->full_name ?? 'User'); ?>

                        </h3>
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-3">
                            <span class="text-white/80 text-sm"><?php echo e($currentUser->email); ?></span>
...
<script>
    window.currentCompanyUserRole = '<?php echo e($currentUserRole); ?>';
    window.currentCompanyRoleColor = '<?php echo e($roleColor); ?>';
        ...
        if (ctx) {
            ...
            if (titleElement) {
                if (ctx.type === 'workspace' && ctx.workspaceName) {
                    ...
                    titleElement.textContent = `Akses Anda di <?php echo e($activeCompany->name ?? 'Perusahaan'); ?>`;
                }
            }
            ...
            if (ctx.type === 'workspace' && ctx.workspaceId) {
                ...
                if (userRoleElement) {
                    const role = ctx.userRole || window.currentCompanyUserRole || '<?php echo e($currentUserRole); ?>';
                    const colorMap = {
                        'Super Admin': '#102A63',
                        'SuperAdmin': '#102A63',
                        'Administrator': '#DC2626',
...
<?php /**PATH C:\xampp\htdocs\koladi\resources\views/components/hak-akses.blade.php ENDPATH**/ ?>