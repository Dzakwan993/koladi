<?php $__env->startSection('title', 'Kelola Workspace'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="p-6" x-data="workspaceManager">
        ...
        <div class="m-8">
            ...
            <div x-show="timOpen" x-collapse>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $workspaces['Tim'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <!-- ✅ PERBAIKAN: Link ke workspace spesifik -->
                        <a href="<?php echo e(route('workspace.detail', $workspace->id)); ?>"
                            ...
                            <div class="flex justify-between items-start">
                                <h3 class="font-semibold text-gray-800"><?php echo e($workspace->name); ?></h3>

                                <!-- tombol titik tiga -->
                                <button @click.stop.prevent="openWorkspaceMenu($event, <?php echo e(json_encode($workspace)); ?>)"
                            ...
                            <p class="text-sm text-gray-600 mt-2">
                                <?php echo e($workspace->description ?? 'Tidak ada deskripsi'); ?>

                            </p>

                            <div class="mt-4">
                                <div class="flex -space-x-2">
                                    <?php $__currentLoopData = $workspace->userWorkspaces->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userWorkspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <img src="<?php echo e($memberAvatar); ?>" alt="<?php echo e($member->full_name); ?>"
                                            class="w-8 h-8 rounded-full border-2 border-white object-cover"
                                            title="<?php echo e($member->full_name); ?>">
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                    <?php if($workspace->userWorkspaces->count() > 4): ?>
                                        <div
                                            class="w-8 h-8 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center">
                                            <span
                                                class="text-xs text-gray-600">+<?php echo e($workspace->userWorkspaces->count() - 4); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
        ...
        <div class="mb-4 mx-8 mt-8">
            ...
            <div x-show="proyekOpen" x-collapse>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $workspaces['Proyek'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <!-- ✅ PERBAIKAN: Link ke workspace spesifik -->
                        <a href="<?php echo e(route('workspace.detail', $workspace->id)); ?>"
                            class="block bg-white rounded-xl border border-gray-200 p-4 relative group hover:shadow-md transition-shadow duration-200">
                            <div class="flex justify-between items-start">
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('workspaceManager', () => ({
                ...
                canEditDeleteWorkspace: <?php echo e($canEditDeleteWorkspace ? 'true' : 'false'); ?>,

                canManageMembers(workspace) {
                    if (!workspace) return false;
                    // ✅ CEK ROLE USER DI COMPANY (dari PHP)
                    const userCompanyRole = '<?php echo e($userRole); ?>';
    ...
    await this.confirmAction(
        ...
        async () => {
            ...
            if (result.success) {
                ...
                getDefaultRoleId() {
                    return '<?php echo e(\App\Models\Role::where('name', 'Member')->first()->id ?? ''); ?>';
                }
            }));
        });
    </script>
    ...
    <script>
        ...
        window.availableRolesForWorkspace = <?php echo json_encode($workspaceRoles, 15, 512) ?>;
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const step = '<?php echo e(Auth::user()->onboarding_step ?? ''); ?>';
...
`;
            ...
            function completeOnboardingStep5() {
                ...
                setTimeout(() => {
                    ...
                    // Complete onboarding
                    fetch('<?php echo e(route('complete-onboarding')); ?>', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\koladi\resources\views/kelola-workspace.blade.php ENDPATH**/ ?>