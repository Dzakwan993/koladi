...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#1E1E1E] mb-2 truncate">
                                Selamat datang, <?php echo e(getShortName(Auth::user()->full_name)); ?> 👋
                            </h1>
                        ...
                        <a href="<?php echo e(url('/tambah-anggota')); ?>" role="button" aria-label="Tambah Anggota Baru"
                                ...
                                <div class="space-y-3 sm:space-y-4 px-1">
                                    <?php $__empty_1 = true; $__currentLoopData = $pengumumans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="group bg-gradient-to-br from-[#E9EFFD] to-[#dce6fc] rounded-xl p-3 sm:p-4 shadow-sm hover:shadow-2xl transition-all duration-300 cursor-pointer border border-blue-100 hover:border-blue-400 focus-within:ring-2 focus-within:ring-blue-400"
                                            onclick="window.location.href='<?php echo e(route('pengumuman-perusahaan.show', ['company_id' => $company->id, 'id' => $p->id])); ?>'"
                                            tabindex="0" role="article" aria-label="Pengumuman: <?php echo e($p->title); ?>">

                                            
                                            <div class="flex items-start justify-between mb-3 gap-2">
                                                <div class="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                                                    <img src="<?php echo e($p->creator->avatar_url); ?>"
                                                        alt="Avatar <?php echo e($p->creator->full_name); ?>" loading="lazy"
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <p class="font-semibold text-xs sm:text-sm text-gray-800 truncate">
                                                            <?php echo e($p->creator->full_name); ?>
                                                        ...
                                                        <div class="flex items-center gap-1.5 sm:gap-2 mt-0.5">
                                                            ...
                                                            <span class="text-xs text-gray-500">
                                                                ...
                                                                <?php echo e($p->display_relative_time ?? $p->created_at->diffForHumans()); ?>
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="relative">
                                                            <div class="bg-gradient-to-br from-yellow-400 to-yellow-500 text-gray-800 text-xs font-bold rounded-lg w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300"
                                                                aria-label="<?php echo e($p->comments_count); ?> komentar">
                                                                <?php echo e($p->comments_count); ?>
                                                ...
                                                <div
                                                    ...
                                                    <?php if($p->due_date): ?>
                                                        <span class="text-xs font-medium text-blue-700">
                                                            Tenggat:
                                                            <?php echo e(\Carbon\Carbon::parse($p->due_date)->translatedFormat('d M Y')); ?>
                                                    ...
                                                    <?php if($p->auto_due): ?>
                                                        <span class="text-xs text-gray-600">
                                                            • Selesai:
                                                            <?php echo e(\Carbon\Carbon::parse($p->auto_due)->translatedFormat('d M Y')); ?>
                            ...
                            <div class="overflow-y-auto flex-1 pr-2 custom-scrollbar">
                                <div class="space-y-2 sm:space-y-3 schedule-cards-container">
                                    <?php $__empty_1 = true; $__currentLoopData = $todaySchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <a href="<?php echo e($schedule->schedule_type === 'company' ? route('jadwal-umum.show', $schedule->id) : route('calendar.show', ['workspaceId' => $schedule->workspace_id, 'id' => $schedule->id])); ?>"
                                            ...
                                            <div class="flex items-start justify-between mb-2 gap-2">
                                                <div class="flex items-center gap-2 flex-1 min-w-0">
                                                    <img src="<?php echo e($schedule->creator->avatar_url); ?>"
                                                        alt="<?php echo e($schedule->creator->full_name); ?>"
                                                        class="w-10 h-10 rounded-full object-cover border-2 border-white shadow-md flex-shrink-0">

                                                    <div class="flex-1 min-w-0">
                                                        <p class="font-semibold text-sm text-gray-800 truncate">
                                                            <?php echo e($schedule->creator->full_name); ?>

                                                        </p>
                                                        
                                                        <span
                                                            class="inline-block text-xs px-2 py-0.5 rounded-full mt-1 <?php echo e($schedule->schedule_type === 'company' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'); ?>">
                                                            <?php echo e($schedule->schedule_label); ?>
                                                ...
                                                <?php if($schedule->comments_count > 0): ?>
                                                    <div class="flex-shrink-0">
                                                        <div
                                                            ...
                                                            <?php echo e($schedule->comments_count); ?>
                                            ...
                                            <div class="flex flex-col gap-1">
                                                <div class="flex items-center gap-1.5 text-xs text-gray-600">
                                                    ...
                                                    <span><?php echo e($schedule->start_datetime->format('H:i')); ?> -
                                                        <?php echo e($schedule->end_datetime->format('H:i')); ?> WIB</span>
                                                </div>

                                                <?php if($schedule->is_online_meeting): ?>
                                                    <div class="flex items-center gap-1.5 text-xs text-gray-600">
                                                ...
                                                <?php elseif($schedule->location): ?>
                                                    <div class="flex items-center gap-1.5 text-xs text-gray-600">
                                                        ...
                                                        <span class="truncate"><?php echo e($schedule->location); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </a>
    ...
    <?php if(isset($showOnboarding) && $showOnboarding): ?>
        <?php if($onboardingType === 'member'): ?>
            
            <?php echo $__env->make('components.onboarding-member', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php else: ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const shouldShowOnboarding = <?php echo e(isset($showOnboarding) && $showOnboarding ? 'true' : 'false'); ?>;
                const onboardingType = '<?php echo e($onboardingType ?? "founder"); ?>';
...
`;
    ...
    `;
                ...
                newButton.addEventListener('click', function(e) {
                    ...
                    // Simpan step
                    fetch('<?php echo e(route('update-onboarding-step')); ?>', {
                            method: 'POST',
                            headers: {
            ...
            function skipOnboarding() {
                fetch('<?php echo e(route('mark-onboarding-seen')); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\koladi\resources\views/dashboard.blade.php ENDPATH**/ ?>